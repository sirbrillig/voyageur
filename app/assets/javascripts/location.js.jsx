...
var Location = (function() { // jshint ignore:line
  ...
  return React.createClass({
    ...
    dragOver: function( evt ) {
      ...
      var sameType = false;
      if ( typeof types.contains === 'function' ) sameType = types.contains( 'librarylocation' );
      if ( typeof types.indexOf === 'function' ) sameType = ( ~ types.indexOf( 'librarylocation' ) );
    ...
    render: function() {
      return (
        <li className={"location" + ( this.state.movingOver ? ' moving-over' : '' ) + ( this.state.moving ? ' moving' : '' ) + ( this.props.selected ? ' selected-location' : '' )}
